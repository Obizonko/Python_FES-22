...
from bees import EmployedBee, InspectorBee
    ...
    def run(self) -> None:
        while True:
            ...
            for i in range(len(bee_assignments)):
                ...
                print(
                    f'picked cell ({assignment.cell.x}, {assignment.cell.y}) w val = {assignment.cell.val} and max_load = {assignment.cell.max_load}')
