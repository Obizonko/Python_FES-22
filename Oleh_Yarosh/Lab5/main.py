...
if __name__ == '__main__':
    ...
    student.average_grade = 85.0

    # Create a PostgraduateStudent object
    postgrad_student = PostgraduateStudent(personal_info, department, phd_status="In progress")
    ...
    seminar = Seminar(
        ...
        deadline=datetime(2023, 5, 31),
        assignments=[{"name": "Assignment 1", "grade": 90}],
        status="Active",
        related_course="Introduction to Programming"
    )
